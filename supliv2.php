...
Supprimer une livraison                    
 <span class="tools pull-right">
                            ...
                            <div class="form">
                                <form method="POST"  action="supliv2.php" class="cmxform form-horizontal " id="signupForm" method="get" action="" novalidate="novalidate">
                                    <div class="form-group ">
                                        <label for="firstname" class="control-label col-lg-3">CIN du livreur</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="Reference" name="cin" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button name="sup" class="btn btn-primary" type="submit">Supprimer</button>
...
if(isset($_POST['cin']) )
	...
	$liv= new livC();
	$liv->supprimer($cin);
	echo "<script type='text/javascript'>alert('supression avec sucsée');</script>";
