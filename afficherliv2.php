...
//var_dump($liste);
    ...
    {   
        ...
        echo $ligns["cin"];
            ...
            echo "<span class='label label-success'>Diponible</span>";
            }
            else if ($ligns["dispo"]=='non') {echo "<span class='label label-danger'> Non Diponible</span>";}
            echo "</td>";
         include_once "../core/livraisonC.php";
include_once "../entities/livraison.php";
$id=$_GET['id'];
  $livraison=new livraisonC();
$listeliv1=$livraison->afficher_une_livraison($id);
$liste1=$listeliv1->fetchALL();
//var_dump($liste);


foreach ($liste1 as $ligns1) 
    {   
...
?>    
            ...
            <td><form method="GET" action="afficherliv2.php">
                <input type="hidden" value="<?php echo $ligns1['id']; ?>" name="id">
                <input value="<?php echo $ligns['region']; ?>" name="region" type="hidden" >
                <input value="<?php echo $ligns['cin']; ?>" name="cin1" type="hidden" >
              <button style="background:none;border:none;" name="quit" class="fa fa-check text-success text-active" > </button>
...
include_once "../core/livC.php";
include_once "../entities/liv.php";
 if(isset($_GET['cin1'])&&($_GET['id'])){
$id=$_GET['id'];


    $cin=$_GET['cin1'];
    $liv=new livC();
    $listeliv=$liv->affecter($id,$cin);
    $listeliv=$liv->modifier($cin);
    $listeliv1=$livraison->modifier_liv($id); } 
