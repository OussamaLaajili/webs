...
?>      
  ...
  <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDo7nFkoUthlGms4De0miS4EPfupB5x0cY">
...
<input type="text" id="adresse" value="<?php echo $ligns['region']; ?>" />
<button class="fa fa-location-arrow"   onclick="TrouverAdresse();" style="background:none;border:none;" class="fa fa-check text-success text-active" > </button>

<form method="GET" action="afficherliv2.php">

 <input type="hidden" value="<?php echo $ligns['id']; ?>" name="id">
 <input type="hidden" value="<?php echo $ligns['region']; ?>" name="region">
...
function initialiserCarte() {
  ...
  var latlng = new google.maps.LatLng(36.8679869,10.240385800000013);
  var mapOptions = {
    zoom      : 14,
    center    : latlng,
