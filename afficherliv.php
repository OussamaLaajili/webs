                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="sub">
                        <li><a href="ajoutliv.php">Ajouter un livreur </a></li>
                        <li><a class="active" href="supliv2.php" >Supprimer une livraison</a></li>
...
?>       
 ...
 <tbody>
                ...
                <td><form method="GET" action="supliv.php">
                <input type="hidden" value="<?php echo $ligns['id']; ?>" name="id">
             
              <button style="background:none;border:none;" class="fa fa-times text-danger text" > </button>
          </form>  </td>
            <td><form method="GET" action="geo.php">
                <input type="hidden" value="<?php echo $ligns['id']; ?>" name="id">
                <input type="hidden"value="<?php echo $ligns['email']; ?>" name="emailto" >
              <button style="background:none;border:none;" class="fa fa-check text-success text-active" > </button>
           </form> </td>
            <td><form method="GET" action="imprimerpdf.php">
                <input type="hidden" value="<?php echo $ligns['id']; ?>" name="id">
             <button style="background:none;border:none;" class="fa fa-print" > </button>
         </form>   </td>
         </td>
            <td><form method="GET" action="envoyer.php">
                <input type="hidden" value="<?php echo $ligns['id']; ?>" name="id">
             <button style="background:none;border:none;" class="fa fa-envelope" > </button>
         </form>   </td>
 ...
 <?php      
        ...
        echo "<script type='text/javascript'> alert ('vous avez $x livraison non triaties');</script>";
