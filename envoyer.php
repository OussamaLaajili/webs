                ...
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       <h4 class="gen-case"> Compose Mail
                           <input value="<?php echo $ligns['id']; ?>" type = "hidden"name="id" >
                       </h4>
                    </header>
                        ...
                        <div class="compose-mail">
                            <form role="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <input value="<?php echo $ligns['email']; ?>" name="emailto" type="text" tabindex="1" id="to" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="subject" type="text" tabindex="1" id="subject" class="form-control" value="ACCES UNIVERS BIJOUX :Votre livraison ">
                                </div>
                                ...
                                <div class="compose-btn">
                                   <button name="sup" type="submit"class="btn btn-primary btn-sm"><i class="fa fa-check"></i> Send</button>
...
<?php		
		...
		if(isset($_POST['emailto']) && isset($_POST['message']) )
		{
	$emailto=$_POST['emailto'];
	$message=$_POST['message'];
	$sybject=$_POST['subject'];
		mail($emailto,$sybject,$message);}
	
  $aff = new livraisonC();
	$req = $aff->modifier_liv2($id);		
