        ...
        <nav id="sidebar" class="">
			...
			<div class="nalika-profile">
				<div class="profile-dtl">
					...
					<h2>Oussama <span class="min-dtn"></span></h2>
				</div>
...
{ 
         echo '<li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">'.$_SESSION['l'].'</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
                <li><a href="#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                <li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
                <li><a href="./logout_back.php"><i class="fa fa-key"></i> Log Out</a></li>
            </ul>
        </li>';
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="index.html">
								   ...
								   <span class="mini-click-non">Livraison/Livreur</span>
								</a>
                            <ul class="sub">
                        <li><a class="active" href="ajoutliv.php">Ajouter un livreur </a></li>
                        <li><a href="supliv2.php" >Supprimer une livraison</a></li>
                        <li><a >Modifier une livraison </a></li>
                        <li><a href ="afficherliv.php">Consulter les livraisons\Livreur</a></li>
...
Ajouter un livreur                           
 <span class="tools pull-right">
                        ...
                        <div class="panel-body">
                            <div class=" form">
                                <form method="POST"  action="ajoutliv.php" class="cmxform form-horizontal " id="commentForm" novalidate="novalidate">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">CIN </label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="cin" minlength="2" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <label for="cemail" class="control-label col-lg-3">Région</label>
                                        <div class="col-lg-6">
                                           
                                            <select name="region" class="form-control m-bot15">
    ...
    <option value="24">Zaghouene</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-3 col-lg-6">
                                            <button class="btn btn-primary" type="submit" name="quit">Save</button>
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															...
															<span class="admin-name">Oussama Laajili</span>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											...
											<div class="breadcomb-ctn">
												<h2>Dashboard</h2>
												<p>Admin <span class="bread-ntd">Interface</span></p>
											</div>
										</div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      <?PHP
include_once "../core/livC.php";
include_once "../entities/liv.php";
...
if(isset($_POST['cin'])&&($_POST['nom'])&&($_POST['region']))
   ...
   $region='ariana';
    ...
    $dispo='oui'; 
    if(ctype_digit($cin)&&ctype_alpha($nom))
    {
        
    
    $liv=new livreur($cin,$nom,$region,$dispo);
    $livAjout=new livC();
    $livAjout->ajoutliv($liv);
    echo "<script type='text/javascript'>alert('ajout terminé avec succée');</script>";
    ...
    {
        echo "<script type='text/javascript'>alert('donner un cin et un nom valide');</script>";
